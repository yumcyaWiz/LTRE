...
AABB::AABB(const Vec3& pMin, const Vec3& pMax) : bounds{pMin, pMax} {}

Vec3 AABB::center() const { return 0.5f * (bounds[0] + bounds[1]); }
...
bool AABB::intersect(const Ray& ray, const Vec3& dirInv,
